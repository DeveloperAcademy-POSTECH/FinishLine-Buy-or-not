        ...
        ScrollView{
            VStack() {
                ...
                Button("가입하기") {
                    ...
                    let testUserModel = TestUsersViewModel()
                    testUserModel.addData(name: nickNameInput, comment: "자기소개를 입력해주세요", email: signUpEmailInput, password: signUpPasswordInput, imageURL: "userprofile", interested: "없음")
